                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            ...
                            <input class="form-control" placeholder="-" type="text" name="TWILIO_SID" value="{{ env('TWILIO_SID') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            ...
                            <input class="form-control" placeholder="-" type="text" name="TWILIO_TOKEN" value="{{ env('TWILIO_TOKEN') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6">
                        <div class="primary_input mb-100">
                            ...
                            <input class="form-control" placeholder="-" type="text" name="VALID_TWILLO_NUMBER" value="{{ env('VALID_TWILLO_NUMBER') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            ...
                            <input class="form-control" placeholder="-" type="text" name="TEXT_TO_LOCAL_API_KEY" value="{{ env('TEXT_TO_LOCAL_API_KEY') }}">
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="primary_input mb-25">
                            ...
                            <input class="form-control" placeholder="-" type="text" name="TEXT_TO_LOCAL_SENDER" value="{{ env('TEXT_TO_LOCAL_SENDER') }}">
                        </div>
                    </div>
                </div>
