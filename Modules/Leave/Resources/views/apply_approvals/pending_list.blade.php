                            ...
                            <div class="apply_leave_list">
                                <table class="table Crm_table_active3">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('leave.Email') }}</th>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                                        @if (permissionCheck('languages.edit_modal'))
                                                            <a href="#" class="dropdown-item" onclick="edit_apply_leave_modal({{ $apply_leave->id }})">{{__('common.View')}}</a>
                                                        @endif
                                                        @if (1)
                                                            <a onclick="confirm_modal('{{route('apply_leave.destroy', $apply_leave->id)}}');" class="dropdown-item">{{__('common.Delete')}}</a>
                                                        @endif
                                                    </div>
                                                </div>
                                                <!-- shortby  -->
