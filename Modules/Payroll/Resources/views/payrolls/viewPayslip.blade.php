    ...
    <div class="invoice_info">
        <table class="table table-bordered billing_info">
            ...
            <tr>
                ...
                <td class="p-2" style="font-family: DejaVu Sans;">{{strtoupper($payrollDetails->payment_mode)}}</td>
            </tr>
            <tr>
                <th scope="col">{{ __('payroll.Basic Salary') }}</th>
                <td class="p-2" style="font-family: DejaVu Sans;">{{single_price($payrollDetails->basic_salary)}}</td>
            </tr>
            <tr>
                <th scope="col">{{ __('payroll.Total Earning') }}</th>
                <td class="p-2" style="font-family: DejaVu Sans;">

                    {{single_price($payrollDetails->total_earning)}}
                </td>
            </tr>
            <tr>
                <th scope="col">{{ __('payroll.Total Deduction') }}</th>
                <td class="p-2" style="font-family: DejaVu Sans;">{{single_price($payrollDetails->total_deduction)}}</td>
            </tr>
            <tr>
                <th scope="col">{{ __('payroll.Net Salary') }}</th>
                <td class="p-2" style="font-family: DejaVu Sans;">{{single_price($payrollDetails->net_salary)}}</td>
            </tr>
            <tr>
                <th scope="col">{{ __('payroll.Gross Salary') }}</th>
                <td class="p-2" style="font-family: DejaVu Sans;">{{single_price($payrollDetails->gross_salary)}}</td>
            </tr>
        </table>
    </div>
</div>
