...
Route::group(['middleware' => ['auth', 'permission','systemsubscription']], function(){
    ...
    Route::group(['prefix' => 'report', 'as' => 'report.'], function (){
        Route::get('paymentdue', 'ReportController@paymentdue')->name('paymentdue');
...
Route::group(['prefix' => 'invoice', 'as' => 'invoice.', 'middleware' => ['auth', 'systemsubscription']], function (){
