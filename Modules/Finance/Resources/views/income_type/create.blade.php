@extends('finance::layouts.master', ['title' => __('finance.Create New Income Type')])
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="box_header">
                        <div class="main-title d-flex justify-content-between ">
                            <h3 class="mb-0 mr-30">{{ __('finance.Add Income Type') }}</h3>
                            <ul class="d-flex">
                                @if(permissionCheck('income_types.index'))
                                    <li><a class="primary-btn mr-10 fix-gr-bg" href="{{ route('income_types.index') }}"><i class="ti-list"></i>{{ __
                ...
                <div class="col-12">
                    <div class="white_box_50px box_shadow_white">
                        {!! Form::open(['route' => 'income_types.store', 'class' => 'form-validate-jquery', 'id' => 'content_form', 'files' => false, 'method' => 'POST']) !!}
