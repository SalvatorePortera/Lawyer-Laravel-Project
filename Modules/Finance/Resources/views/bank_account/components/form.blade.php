<div class="row">
    <div class="primary_input col-md-12">
        ...
        {{Form::text('bank_name', null, ['required' => '', 'class' => 'form-control', 'placeholder' => __('finance.bank_name')])}}
    </div>
    <div class="primary_input col-md-6">
        {{Form::label('branch_name', __('finance.branch_name'), ['class' => 'required'])}}
        {{Form::text('branch_name', null, ['required' => '', 'class' => 'form-control', 'placeholder' => __('finance.branch_name')])}}
    </div>
    <div class="primary_input col-md-6">
        {{Form::label('account_name', __('finance.account_name'), ['class' => 'required'])}}
        {{Form::text('account_name', null, ['required' => '', 'class' => 'form-control', 'placeholder' => __('finance.account_name')])}}
    </div>

    <div class="primary_input col-md-6">
        {{Form::label('account_number', __('finance.account_number'), ['class' => 'required'])}}
        {{Form::text('account_number', null, ['required' => '', 'class' => 'form-control', 'placeholder' => __('finance.account_number')])}}
    </div>

    <div class="primary_input col-md-6">
        {{Form::label('opening_balance', __('finance.opening_balance'))}}
        {{Form::text('opening_balance', null, [ 'class' => 'form-control', 'placeholder' => __('finance.opening_balance')])}}
    </div>
</div>
