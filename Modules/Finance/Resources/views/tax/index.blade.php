                            ...
                            <div class="">
                                <table class="table Crm_table_active3">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ __('finance.Tax Name') }}</th>
                                        <th>{{ __('finance.Rate') }} (%)</th>
                                            ...
                                            <td>
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        @if(permissionCheck('taxes.edit'))
                                                            <a href="{{ route('taxes.edit', $model->id) }}"
                                                               class="dropdown-item edit_brand">{{__('common.Edit')}}</a>
                                                        @endif
                                                        @if(permissionCheck('taxes.destroy'))
                                                            <a href="#" data-id="{{ $model->id }}" data-url="{{ route('taxes.destroy', $model->id)}}"
