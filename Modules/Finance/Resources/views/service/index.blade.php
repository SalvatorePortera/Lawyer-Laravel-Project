                ...
                <div class="col-12">
                    <div class="box_header common_table_header xs_mb_0">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('finance.Service List') }}</h3>
                            <ul class="d-flex">
                                @if(permissionCheck('services.store'))
                                    <li><a class="primary-btn mr-10 fix-gr-bg"
                                           href="{{ route('services.create') }}"><i class="ti-plus"></i>{{ __('finance.New Service') }}</a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        @if(permissionCheck('services.edit'))
                                                            <a href="{{ route('services.edit', $model->id) }}"
                                                               class="dropdown-item edit_brand">{{__('common.Edit')}}</a>
                                                        @endif
                                                        @if(permissionCheck('services.destroy'))
                                                            <a href="#" data-id="{{ $model->id }}" data-url="{{ route('services.destroy', $model->id)}}"
