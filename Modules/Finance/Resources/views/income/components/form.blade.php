<div class="row">
    <div class="primary_input col-md-6">
        ...
        {{Form::text('title', null, ['required' => '', 'class' => 'form-control', 'placeholder' => __('finance.Income Title')])}}
    </div>
    ...
    <div class="primary_input col-md-6">
        ...
        {{Form::select('income_type', $service_types,  ((isset($model) and $model) ? $model->morphable_id : null), ['required' => '', 'class' => 'form-control select2bs4', 'data-parsley-errors-container' => '#income_type_error', 'id' => 'income_type'])}}
    ...
    <div class="primary_input col-md-6">
        ...
        {{Form::text('amount', null, ['required' => '', 'class' => 'form-control', 'placeholder' => __('finance.Income Amount')])}}
    </div>
    <div class="primary_input col-md-6">
