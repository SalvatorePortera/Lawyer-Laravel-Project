...
class ExpenseRequest extends FormRequest
{
    ...
    {
        $validate_rules = [
            'expensefor' => ['sometimes', 'nullable', 'string', 'max:20'],
            'service_type' => ['sometimes', 'nullable', 'integer', 'max:11'],
            'expense_type' => ['sometimes', 'nullable','integer',
            ...
            'clientable_id' => ['sometimes', 'nullable', 'integer', 'max:11'],
            'case_id' => ['sometimes', 'nullable', 'integer', 'max:11'],
