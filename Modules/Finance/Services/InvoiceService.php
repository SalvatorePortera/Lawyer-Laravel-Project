...
class InvoiceService
{
    ...
    public function getDueStatusByDate(array $request)
    {
        $start = gv($request, 'start');
        $end= gv($request, 'end');
    ...
    private function formatInvoiceRequest(array $requests, $invoice = null)
    {
        ...
        $formatRequest = [
            ...
            'invoice_date' => toDate(gv($requests, 'invoice_date', date('Y-m-d'))),
            'due_date' => toDate(gv($requests, 'due_date')),
