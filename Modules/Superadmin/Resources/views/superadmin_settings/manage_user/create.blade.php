...
<section class="content">
  {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\DefaultManageUserController@store'), 'method' => 'post', 'id' => 'user_add_form' ]) !!}
  <div class="row">
    <div class="col-md-12">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          {!! Form::select('role', $roles, null, ['class' => 'form-control select2', 'required','placeholder' => __('lang_v1.please_select')]); !!}
        </div>
      </div>
      <div class="clearfix"></div>
      <div class="col-md-3">
