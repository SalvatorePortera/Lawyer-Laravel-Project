            ...
            <div class="box-body">
                <div class="row">
                    <input type="hidden" id="currency_symbol" name="currency_symbol"
                           value="{{$packages->currency_symbol}}">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('report_verification', 1, $packages->report_verification, ['class' => 'input-icheck','id'=>'report_verification']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('report_table', 1, $packages->report_table, ['class' => 'input-icheck','id'=>'report_table']); !!}
                                        Table Report
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('report_staff_service', 1, $packages->report_staff_service, ['class' => 'input-icheck','id'=>'report_staff_service']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('edit_received_outstanding', 1, $packages->edit_received_outstanding, ['class' => 'input-icheck', 'id'=>'edit_received_outstanding']); !!}
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('cheque_write_module', 1, $packages->cheque_write_module, ['class' => 'input-icheck','id'=>'cheque_write_module']); !!}
                                        {{__('Cheque Writing Module')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('all_cheque_write_module', 1, false, ['class' => 'input-icheck','id'=>'all_cheque_write_module']); !!}
                                        {{__('Select All In Cheque Writing Module')}}
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('cheque_templates', 1, $packages->cheque_templates, ['class' => 'input-icheck', 'id'=>'cheque_templates']); !!}
                                        {{__('Templates')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('write_cheque', 1, $packages->write_cheque, ['class' => 'input-icheck','id'=>'write_cheque']); !!}
                                        {{__('Write Cheque')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('manage_stamps', 1, $packages->manage_stamps, ['class' => 'input-icheck','id'=>'manage_stamps']); !!}
                                        {{__('Manage Stamps')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('manage_payee', 1, $packages->manage_payee, ['class' => 'input-icheck','id'=>'manage_payee']); !!}
                                        {{__('Manage Payee')}}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('cheque_number_list', 1, $packages->cheque_number_list, ['class' => 'input-icheck','id'=>'cheque_number_list']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('deleted_cheque_details', 1, $packages->deleted_cheque_details, ['class' => 'input-icheck','id'=>'deleted_cheque_details']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('printed_cheque_details', 1, $packages->printed_cheque_details, ['class' => 'input-icheck','id'=>'printed_cheque_details']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('default_setting', 1, $packages->default_setting, ['class' => 'input-icheck','id'=>'default_setting']); !!}
                                        {{__('Default Settings')}}
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-3 @if(!$packages->hospital_system) hide @endif hospital_business_type">
                        <div class="form-group">
                            ...
                            <select name="hospital_business_type[]" id="hospital_business_type" class="form-control"
                                ...
                                <option @if(in_array( 'hosp_and_dis' , $hbt)) selected @endif value="hosp_and_dis">
                                    Hospitals
                                    &
                                    Dispensaries
                                </option>
                                <option @if(in_array( 'pharmacies' , $hbt)) selected @endif value="pharmacies">
                                    Pharmacies
                                </option>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('No_of_backups ', 'No of backups') !!}
                            {!! Form::number('no_of_backup', $packages->no_of_backup, ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('No_of_backups ', 'No of Days') !!}
                            {!! Form::number('no_of_day', $packages->no_of_day, ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
...
@section('javascript')
    ...
    <script>
        ...
        $('#all_report_module').on('ifChecked', function (event) {
            ...
            $('#report_verification').iCheck('check');
            $('#report_table').iCheck('check');
            $('#report_staff_service').iCheck('check');
        })
        $('#all_report_module').on('ifUnchecked', function (event) {
            ...
            $('#report_verification').iCheck('uncheck');
            $('#report_table').iCheck('uncheck');
            $('#report_staff_service').iCheck('uncheck');
        })
        ...
        $('#all_cheque_write_module').on('ifChecked', function (event) {

            $('#cheque_templates').iCheck('check');
            $('#write_cheque').iCheck('check');
            $('#manage_stamps').iCheck('check');
            $('#manage_payee').iCheck('check');
            $('#cheque_number_list').iCheck('check');
            $('#deleted_cheque_details').iCheck('check');
            $('#printed_cheque_details').iCheck('check');
            $('#default_setting').iCheck('check');
        })
        $('#all_cheque_write_module').on('ifUnchecked', function (event) {
            $('#cheque_templates').iCheck('uncheck');
            $('#write_cheque').iCheck('uncheck');
            $('#manage_stamps').iCheck('uncheck');
            $('#manage_payee').iCheck('uncheck');
            $('#cheque_number_list').iCheck('uncheck');
            $('#deleted_cheque_details').iCheck('uncheck');
            $('#printed_cheque_details').iCheck('uncheck');
            $('#default_setting').iCheck('uncheck');
        })
    </script>
@endsection
