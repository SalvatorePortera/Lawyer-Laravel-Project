                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('report_verification', 1, false, ['class' => 'input-icheck','id'=>'report_verification']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('report_table', 1, false, ['class' => 'input-icheck','id'=>'report_table']); !!}
                                        Table Reports
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('report_staff_service', 1, false, ['class' => 'input-icheck','id'=>'report_staff_service']); !!}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('edit_received_outstanding', 1, false, ['class' => 'input-icheck', 'id'=>'edit_received_outstanding']); !!}
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('cheque_write_module', 1, false, ['class' => 'input-icheck','id'=>'cheque_write_module']); !!}
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('cheque_templates', 1, false, ['class' => 'input-icheck', 'id'=>'cheque_templates']); !!}
                                        {{__('Templates')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('write_cheque', 1,false, ['class' => 'input-icheck','id'=>'write_cheque']); !!}
                                        {{__('Write Cheque')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('manage_stamps', 1, false, ['class' => 'input-icheck','id'=>'manage_stamps']); !!}
                                        {{__('Manage Stamps')}}
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('manage_payee', 1, false, ['class' => 'input-icheck','id'=>'manage_payee']); !!}
                                        {{__('Manage Payee')}}
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('cheque_number_list', 1, false, ['class' => 'input-icheck','id'=>'cheque_number_list']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('deleted_cheque_details', 1, false, ['class' => 'input-icheck','id'=>'deleted_cheque_details']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('printed_cheque_details', 1, false, ['class' => 'input-icheck','id'=>'printed_cheque_details']); !!}
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label class="flex-label">
                                        {!! Form::checkbox('default_setting', 1, false, ['class' => 'input-icheck','id'=>'default_setting']); !!}
                                        {{__('Default Settings')}}
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::number('no_of_backup', '', ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('No_of_backups ', 'No of Days') !!}
                            {!! Form::number('no_of_day', '', ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
