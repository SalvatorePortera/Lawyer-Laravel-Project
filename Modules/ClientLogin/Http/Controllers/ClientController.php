...
class ClientController extends Controller
{
    ...
    public function my_profile()
    {
        ...
        return view('clientlogin::profile', compact('user', 'countries', 'states', 'cities','files', 'fields','cases','invoices'));
    }
    public function upload_my_file(Request $request)
    {
        ...
        if ($request->file){
            ...
            foreach($request->file as $file){
                $this->storeUserFile($file,request()->invoice_id,request()->case_id,$date_id);
            }
        }
    ...
    public function destroy_my_file($id)
    {
        ...
        $file->delete();
        return response()->json(['message' => __('common.Successfully deleted'), 'goto' => route('client.my_profile', $case_id)]);
    }
