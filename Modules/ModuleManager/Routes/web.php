...
Route::prefix('modulemanager')->middleware('auth', 'permission','systemsubscription')->group(function () {
    Route::get('/', 'ModuleManagerController@ManageAddOns')->name('modulemanager.index');
    
});
Route::prefix('modulemanager')->middleware('auth','systemsubscription')->group(function () {
...
Route::middleware('auth','systemsubscription')->group(function () {
