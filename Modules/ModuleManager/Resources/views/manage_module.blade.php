                                        ...
                                        <td>
                                            @if(isset($config))
                                                @php
                                                    ...
                                                    echo '<br>';
                                                    echo 'Version: '.$config->$name->versions[0].' | Developed By <a href="https://1.com/">Syzygy</a>';
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on('change','#validity_period_type', function(e){
            e.preventDefault();
            var activate_date = $('#activate_date').val();
            var validity_period_type_value = $('#validity_period_type_value').val();
            var type = this.value;
            if(activate_date && validity_period_type_value){
                console.log('activate_date = '+activate_date);
                console.log('validity_period_type = '+this.value);
                console.log('validity_period_type_value = '+validity_period_type_value);
            }
        });
    </script>
@endpush
