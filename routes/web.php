...
Route::get('/system-expired', function(){
...
Route::middleware('permission','systemsubscription')->prefix('hr')->group(function(){
...
Route::group(['middleware' => ['systemsubscription']], function () {
...
Route::group(['middleware' => ['auth','systemsubscription']], function () {
    ...
    Route::get('/packages/get_option_variables', '\Modules\Superadmin\Http\Controllers\PackagesController@getOptionVariables'); //for normal pacakge
...
Route::group(['as' => 'select.', 'prefix' => 'select', 'middleware' => ['auth','systemsubscription']], function () {
