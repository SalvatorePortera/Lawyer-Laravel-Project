@extends('layouts.master', ['title' => __('case.Update Case Category')])
            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex justify-content-between w-100">
                        <h3 class="mb-0 mr-30">{{ __('case.Edit Case Stage')}}</h3>
                ...
                <div class="col-12">
                    <div class="white_box_50px box_shadow_white">
                        ...
                        {!! Form::model($model, ['route' => ['category.case.update', $model->id], 'class' =>
