@extends('layouts.master', ['title' => __('court.Create New Court Category')])
            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex justify-content-between w-100">
                        <h3 class="mb-0 mr-30">{{ __('court.New Court Category') }}</h3>
                ...
                <div class="col-12">
                    ...
                    {!! Form::open(['route' => 'category.court.store', 'class' => 'form-validate-jquery', 'id' =>
