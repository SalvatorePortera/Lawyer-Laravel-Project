@extends('layouts.master', ['title' => __('court.Update Court Category')])
            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex justify-content-between w-100">
                        ...
                        <h3 class="mb-0 mr-30">{{__('court.Update Court Category')}}</h3>
                ...
                <div class="col-12">
                    ...
                    {!! Form::model($model, ['route' => ['category.court.update', $model->id], 'class' =>
                    ...
                    <div class="primary_input">
                        ...
                        {{Form::textarea('description', null, ['class' => 'form-control', 'placeholder' =>
                         __('court.Court Category Description'), 'rows' => 5 ])}}
                    </div>
