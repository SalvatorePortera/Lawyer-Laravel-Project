                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::select('acts[]', $data['acts'], null, ['required' => '', 'class' => 'form-control select2bs4', 'data-placeholder' => __('case.Select Acts'),  'data-parsley-errors-container' => '#act_error', 'multiple' => '', 'id' => 'acts'])}}
                        ...
                        <div class="row">
                            ...
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::number('ref_mobile', null, ['class' => 'form-control', 'placeholder' => __('case.Reference Mobile')])}}
                            </div>
                        </div>
                        <div class="row">
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::select('lawyer_id[]', $data['lawyers'], null, ['class' => 'form-control select2bs4', 'data-placeholder' => __('case.Select Lawyer'),  'data-parsley-errors-container' => '#lawyer_id_error', 'multiple', 'id' => 'lawyer_id'])}}
                        ...
                        <div class="row">
                            <div class="primary_input col-md-12">
                                ...
                                {{Form::text('case_charge', 0, ['class' => 'form-control', 'placeholder' => __('case.Case Charge')])}}
                            </div>
                        </div>
                        <div class="row">
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::text('receiving_date', date('Y-m-d H:i'), ['style' => 'display:none;','class' => 'form-control primary-input form-control datetime', "id"=>"receiving_date",'placeholder' => __('case.Date')])}}
                            </div>
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::text('filling_date', date('Y-m-d H:i'),['style' => 'display:none;','class' => 'form-control primary-input form-control datetime', "id"=>"filling_date",'placeholder' => __('case.Date')])}}
                            </div>
                        </div>
                        <div class="row">
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::text('hearing_date', date('Y-m-d H:i'), ['style' => 'display:none;','class' => 'form-control primary-input form-control datetime', "id"=>"hearing_date",'placeholder' => __('case.Date')])}}
                            </div>
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::text('judgement_date', date('Y-m-d H:i'),['style' => 'display:none;','class' => 'form-control primary-input datetime form-control', "id"=>"judgement_date",'placeholder' => __('case.Date')])}}
                            </div>
                        </div>
