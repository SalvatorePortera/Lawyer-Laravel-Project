@extends('layouts.master', ['title' => __('Archieved Case')])
                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('case.Archieved Case') }}</h3>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="primary_input mb-15">
                                        ...
                                        <div class="primary_datepicker_input">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="">
                                                    {{Form::text('date', date('m-d-Y'), ['class' => 'primary_input_field primary-input date form-control date', "id"=>"fromDate",'placeholder' => __('common.Date')])}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @foreach($models as $model)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('case.show', $model->id) }}"><b>{{ __('common.Title') }}: </b>{{ $model->title }}
                                                </a>
                                                <br>
                                                <b>{{ __('case.Next Hearing Date') }}: </b> {{$model->hearing_date}} <br>
                                                <b>{{ __('case.Filing Date') }}: </b> {{$model->filling_date}}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                        ...
                                                        @if(!$model->judgement)
                                                            ...
                                                            class="icon-calendar3 mr-2"></i>{{ __('common.New Date') }}</a>
                                                            <a href="{{route('putlist.create', ['case' => $model->id])}}" class="dropdown-item"><i
                                                            class="icon-calendar3 mr-2"></i>{{ __('common.New Putlist Date') }}</a>
                                                            <a href="{{route('judgement.create', ['case' => $model->id])}}" class="dropdown-item"><i
                                                            class="icon-calendar3 mr-2"></i>{{ __('common.Judgement') }}</a>
                                                        @endif
