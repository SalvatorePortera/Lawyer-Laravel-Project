                    ...
                    <div class="white_box_50px box_shadow_white">
                        ...
                        <div class="row">
                            ...
                            <div class="primary_input col-md-4">
                                ...
                                {{Form::select('state_id', $states, $state_id, ['class' => 'form-control select2bs4', 'id' => 'state_id', 'data-placeholder' => __('court.Select State'),  'data-parsley-errors-container' => '#state_id_error', 'required'])}}
