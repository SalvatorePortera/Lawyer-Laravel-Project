<div class="modal-dialog  modal-dialog-centered modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">{{ __('case.Add Case stage') }}</h4>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-12">
                    {!! Form::open(['route' => 'master.stage.store', 'class' => 'form-validate-jquery', 'id' => 'case_stage_quick_add_form', 'files' => false, 'method' => 'POST']) !!}
...
<script>
    _formValidation('#case_stage_quick_add_form', true, 'case_stage_add_modal');
</script>
