                    ...
                    <div class="white_box_50px box_shadow_white">
                        ...
                        <div class="row">
                            ...
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::select('court_category_id', $court_categories, null, ['class' => 'form-control select2bs4', 'data-placeholder' => __('court.Court Category'), 'data-parsley-errors-container' => '#court_category_error', 'required'])}}
