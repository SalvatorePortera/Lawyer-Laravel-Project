<div class="modal-dialog  modal-dialog-centered modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">{{ __('case.New Act') }}</h4>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-12">
                    {!! Form::open(['route' => 'master.act.store', 'class' => 'form-validate-jquery', 'id' => 'act_quick_add_form', 'files' => false, 'method' => 'POST']) !!}
...
<script>
    _formValidation('#act_quick_add_form', true, 'act_add_modal');
</script>
