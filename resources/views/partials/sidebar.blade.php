    ...
    <div class="sidebar">
      ...
      <!-- SidebarSearch Form -->
		<div class="form-inline">
			<div class="input-group typeahead__container" data-widget="sidebar-search">
			  <input class="form-control form-control-sidebar liveSearch" type="search" placeholder="Search" aria-label="Search">
