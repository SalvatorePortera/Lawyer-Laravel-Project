...
<div class="card-body">
    ...
    <a href="{{ route('service.preRequisite') }}" class="offset-3 col-sm-6 btn btn-primary mb-20 ">
        {{ __('service::install.refresh') }} </a>
    @else
    <p class="text-center alert alert-success mt-40">
        All The Requirements look's Fine. Let's Dig in
    </p>
    <a href="{{ route('service.license') }}" class="offset-3 col-sm-6 btn btn-primary  mb-20">
