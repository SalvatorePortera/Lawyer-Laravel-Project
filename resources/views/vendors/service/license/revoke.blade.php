@if(!env('APP_SYNC'))
    <button data-target="#license_modal" data-toggle="modal" class="btn btn-primary btn-sm ml-2">
        Revoke License
    </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form method="post" action="{{ route('service.revoke') }}" accept-charset="UTF-8"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <div class="mt-40 d-flex justify-content-between">
                                        ...
                                        <button class="btn btn-primary" type="submit">Revoke License</button>
                                    </div>
                                </div>
                            </div>
                        </form>
