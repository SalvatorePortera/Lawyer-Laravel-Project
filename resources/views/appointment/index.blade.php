                    ...
                    <div class="box_header common_table_header xs_mb_0">
                        <div class="main-title d-md-flex">
                            ...
                            @if(permissionCheck('appointment.store'))
                                <li><a class="primary-btn mr-10 fix-gr-bg" href="{{ route('appointment.create') }}"><i class="ti-plus"></i>{{ __
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                        ...
                                                        @if(permissionCheck('appointment.edit'))
                                                            ...
                                                            <a href="#" data-url="{{route('appointment.destroy', $model->id)}}" class="dropdown-item delete_item">{{__('common.Delete')}}</a>
                                                            @endif
