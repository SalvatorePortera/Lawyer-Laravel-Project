                    ...
                    <div class="white_box_50px box_shadow_white">
                        <form action="{{ route('staffs.store') }}" method="POST" id="staff_addForm"
                            ...
                            <div class="row">
                                    ...
                                    <div class="primary_input mb-25">
                                        ...
                                        <select class="primary_select mb-25" name="role_id" id="role_id"
                                            ...
                                            @foreach (\Modules\RolePermission\Entities\Role::where('id', '!=', 1)->get() as $key => $role)
                                                <option
                                                    value="{{ $role->id }}-{{ $role->type }}">{{ $role->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-xl-6">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label required" for="password">{{__('common.Password')}}</label>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label required"
                                               for="">{{ __('leave.Applicable For Leave') }}</label>
                                        <div class="primary_datepicker_input">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="">
                                ...
                                <div class="col-xl-6 date_of_joining_div">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label required"
                                               for="">{{ __('common.Date of Joining') }}</label>
                                        <div class="primary_datepicker_input">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="">
