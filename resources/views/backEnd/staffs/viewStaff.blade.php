               ...
               <div role="tabpanel" class="tab-pane fade show active" id="studentProfile">
                  <div class="white-box">
                     ...
                     @endif
                      ...
                      @if(moduleStatusCheck('CustomField') and $staffDetails->customFields)
                          <h4 class="stu-sub-head mt-40">{{ __('custom_fields.more_info') }}</h4>

                          @includeIf('customfield::details.show', ['customFields' => $staffDetails->customFields])
