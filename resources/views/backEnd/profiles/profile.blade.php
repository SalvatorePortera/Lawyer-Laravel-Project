@extends('layouts.master', ['title' => __('My Profile')])
                ...
                <div class="col-lg-3">
                    ...
                    <div class="student-meta-box">
                        ...
                        <img class="student-meta-img img-100"
                             src="{{ file_exists(@$staffDetails->user->avatar) ? asset(@$staffDetails->user->avatar) : asset('backEnd/img/Fred_man-512.png') }}"
                             alt="">
                        <div class="white-box">
...
@push('scripts')
    <script type="text/javascript">
        ...
        function profileEdit(el) {
            $.post('{{ route('profile_edit_modal') }}', {_token: '{{ csrf_token() }}', id: el}, function (data) {
                $(".edit_form").html(data);
                $('#profileEditForm').modal('show');
            });
        }
