                    ...
                    <div class="white_box_50px box_shadow_white">
                        ...
                        <div class="row">
                            <div class="primary_input col-md-12">
                                ...
                                {{Form::text('judgement_date', $model->judgement_date, ['required' => '','class' => 'primary_input_field primary-input form-control datetime', 'placeholder' => __('case.Close Case Date')])}}
                            </div>
                        </div>
