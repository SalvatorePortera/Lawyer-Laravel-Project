                                ...
                                <div class="add-visitor">
                                    <table style="width:100%; box-shadow: none;"
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ dateFormat(config('configs')->where('key','system_activated_date')->first()->value) }}</td>
                                        </tr>
                                        <tr>
                                            <td>{{__('setting.Last Update')}}</td>
                                            <td>{{ dateFormat(config('configs')->where('key','last_updated_date')->first()->value) }}</td>
                                        </tr>
