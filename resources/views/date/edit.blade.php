                    ...
                    <div class="white_box_50px box_shadow_white">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                {{Form::select('stage_id', $stages, $model->stage_id, ['class' => 'form-control select2bs4', 'data-placeholder' => __('case.Case Stage')])}}
                            </div>
                            <div class="form-group col-md-12">
                                {{Form::hidden('case', $case)}}
                                {{Form::label('hearing_date', __('case.Hearing Date'), ['class' => 'required'])}}
                                {{Form::text('hearing_date', $model->date, ['required' => '','class' => 'form-control primary-input datetime form-control', 'placeholder' => __('case.Hearing Date')])}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {{Form::textarea('description', null, ['class' => 'form-control summernote', 'placeholder' => __('case.Court Order'), 'required', 'rows' => 5, 'data-parsley-errors-container' =>
                            '#description_error' ])}}
