                    ...
                    <div class="white_box_50px box_shadow_white">
                        ...
                        <div class="row">
                            <div class="primary_input col-md-6">
                                ...
                                {{Form::select('country_id', $countries, null, ['class' => 'form-control select2bs4', 'id' => 'country_id', 'data-placeholder' => __('court.Select country'),  'data-parsley-errors-container' => '#country_id_error', 'required'])}}
